/**
 * @file fetchGigs.tsx
 * @description Provider method to initiate fetching gigs scoped to Tim Sherman via SocketCluster.
 */
...
): boolean => socketClusterMessages.initialMessage(setGigs, 'allGigs:tim');
